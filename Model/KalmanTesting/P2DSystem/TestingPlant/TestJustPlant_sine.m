...
% filename = 'F:\TylerFiles\GitHubRepos\BatteryModel\Model\KalmanTesting\P2DSystem\TestingPlant\KalmanTest_JustPlant_Polar_0.04C_D.mat'; % This one is already initialized from the setup
load(filename)
...
%% Run Simulation
    % Create Model Object
        mdl = 'P2D_JustPlantStep_NoNoise_NoVarInput_sine';
        load_system(mdl)
