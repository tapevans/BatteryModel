...
function [AN,CA,SEP,EL,SIM,N,FLAG] = batt_inputs_HZ_B(SIM)
%% Flags
...
% ---- Anode ----
    ...
    AN.i_0_ref  = (4.2665e-4)*(100^2);  % [A m^-2],       Reference exchange current density MODEL B
    AN.C_dl     = (1.1225e-7)*(100^2);  % [F m^-2],       Double-layer capacitance MODEL B
...
% ---- Cathode ----
    ...
    CA.i_0_ref  = (4.0947e-4)*(100^2);  % [A m^-2],       Reference exchange current density MODEL B
    CA.C_dl     = (2.2776e-5)*(100^2);  % [F m^-2],       Double-layer capacitance MODEL B
...
% Thermal 
    ...
    switch FLAG.TempBC
        case 0 % Manual
            SIM.T_inf = 30 + 273.15; % [K], Ambient temperature
        case 1 % Isothermal20
    ...
    if FLAG.InitialThermalGradient
        ...
        switch FLAG.TempBC
            case 0 % Manual
                SIM.Temp_init = 30 + 273.15; % [K], Initial temperature of the cell
            case 1 % Isothermal20
