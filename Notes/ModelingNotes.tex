...
\section{New Stuff}
	...
	\subsection{COE}
		\begin{gather}
			...
			%
			%\rho c_\text{p}  \frac{\partial T }{\partial t} = - \left( \dot{q}''_\text{cond,out} - \dot{q}''_\text{cond,in} \right) \frac{ A_\text{c} }{ V } - \dot{q}''_\text{conv} \frac{ A_\text{outside} }{V} + \dot{q}'''_\text{gen} \\
			%
			%\rho c_\text{p}  \frac{\partial T }{\partial t} = - \left( \dot{q}''_\text{cond,out} - \dot{q}''_\text{cond,in} \right) \frac{1}{ \Delta x } - \dot{q}''_\text{conv} \frac{ A_\text{outside} }{V} + \dot{q}'''_\text{gen} \label{eqn:COE_Balance}
		\end{gather}
		where
		\begin{gather}
		...
		\begin{gather}
			\dot{q}_\text{gen,elec} = i_\text{ed} A_\text{c} \Delta \phi_\text{ed} %\hspace{10pt} \text{Units: W}
			%\dot{q}'''_\text{gen,elec} = i_\text{ed} \nabla \phi_\text{ed} \hspace{10pt} \text{Units: W m$^{-3}$}
		\end{gather}
		...
		\begin{gather}
			...
			%\dot{q}'''_\text{gen,ionic} = i_\text{el} \nabla \phi_\text{el} 
		\end{gather}
		...
		\begin{gather}
			...
			%\dot{q}'''_\text{gen,Far} = \frac{ \dot{Q}_\text{gen,Far} }{ V_\text{CV} } \\
			%\dot{q}'''_\text{gen,Far} = i_\text{BV} A_\text{s} V_\text{SEI} 
		\end{gather}			
