...
function [q_cond , q_conv , q_gen] = thermalAllVectors( SV , AN , SEP, CA , EL , SIM , P , N , CONS , FLAG , props, i_el, i_ed, i_Far)
%% Conduction 
    [q_cond] = thermalFluxConduction( SV , AN , SEP, CA , EL , SIM , P , N , CONS , FLAG , props); % [J s^-1 m^-2]
