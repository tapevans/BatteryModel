...
%% Ho-Kalman
    if FLAG.Analysis.ROM_HoKal
        ...
        if FLAG.PLOT_HK_BodeNyquist
        % Combined
            figure
            nyquist(-sys_HK{end}(1),'k')
            legend('Combined')
        ...
        % Both
            figure
            nyquist(sys_HK{end}(1),'k',sys_HK{1}(1)  ,'ro')
            legend('Combined','Individual')
    
            figure
            bode(sys_HK{end}(1),'k',sys_HK{1}(1),'ro')
            legend('Combined','Individual')
        end
