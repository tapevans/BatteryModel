...
function [AN,CA,SEP,EL,SIM,N,FLAG] = batt_inputs_Wiley_Lui(SIM)
%% Flags    
...
% ---- Anode ----
    ...
    AN.lambda   = 1.04*1e-3;            % [W m^-1 K^-1],  Thermal conductivity of active material %sciencedirect.com/science/article/pii/S0735193317300179        
...
% ---- Electrolyte ----
    ...
    EL.lambda     = 470;    % [W m^-1 K^-1],  Thermal conductivity of electrolyte %sciencedirect.com/science/article/pii/S0735193317300179
...
%% Cell Geometry
    ...
    % ---- Electrolyte ----
        ...
        EL.alpha_brug_an  = 1.5; % [-], Bruggeman exponential factor
        EL.alpha_brug_sep = 1.5; % [-], Bruggeman exponential factor
        EL.alpha_brug_ca  = 1.5; % [-], Bruggeman exponential factor
