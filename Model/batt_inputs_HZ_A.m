...
function [AN,CA,SEP,EL,SIM,N,FLAG] = batt_inputs_HZ_A(SIM)
%% Flags
...
% ---- Anode ----
    ...
    AN.i_0_ref  = (9.8388e-4)*(100^2);  % [A m^-2],       Reference exchange current density MODEL A
    AN.C_dl     = (7.5658e-5)*(100^2);  % [F m^-2],       Double-layer capacitance MODEL A
