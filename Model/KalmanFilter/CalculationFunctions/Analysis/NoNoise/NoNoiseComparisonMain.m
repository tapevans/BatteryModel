...
if FLAG.Analysis.ode
    [RESULTS.ode.t_soln, RESULTS.ode.x_soln, RESULTS.ode.z_soln] = getNoNoiseStepODE(SIM,FLAG,N,P);
end
...
if FLAG.Analysis.ROM_HoKal
    ...
    % Run Simulation
        [RESULTS.ROM_HoKal.z_soln,RESULTS.ROM_HoKal.t_soln,RESULTS.ROM_HoKal.x_soln] = lsim(sys_HK,SIM.InputSignal(:,2),SIM.InputSignal(:,1),x_red);
