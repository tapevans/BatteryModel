...
function [i_ed , i_el ] = currentCalc(  sigma_vec_interface, kappa_vec_interface, dmudc_vec_interface, tf_vec_interface, ...
    ...
    i_el = -  kappa_vec_interface.*phi_el_grad ...
           -  kappa_vec_interface.*tf_vec_interface.*CONS__F_inv.*dmudc_vec_interface.*Ce_grad...
           -  kappa_vec_interface.*EL__Beta.*T_grad;
