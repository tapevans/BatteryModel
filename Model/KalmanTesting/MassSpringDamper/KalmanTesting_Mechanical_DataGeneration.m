...
% Noise
% Q_0_vec = [1e-6 ]; % Process Noise
% R_0_vec = [1e-6 ]; % Measurement Noise
    ...
    for RR = R_0_vec
        for TT = Ts_vec
            for CC = C_vec
                ...
                filename = ['Step_Q' Q_str '_R' R_str '_Ts' Ts_str '_C' C_str '.mat'];

                path_str = 'F:\TylerFiles\GitHubRepos\BatteryModel\Model\KalmanTesting\MassSpringDamper\Step_CodedPlantResultsQState';
