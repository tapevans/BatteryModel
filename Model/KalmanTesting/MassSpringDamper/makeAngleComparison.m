...
% Use Selected Data
    ...
    Ts_vec_spec  = [.01 .05 .1 .5 1 5 1 5 10 25 40 50]; % [s]
    C_vec_spec   = [1 2 3 4];


%     Q_0_vec_spec = [1e-1 1e0 1e1]; % Process Noise
%     R_0_vec_spec = [1e-6]; % Measurement Noise
%     Ts_vec_spec  = [.01 .05 0.10 ]; %5 1 5 25 40 50
%     C_vec_spec   = [1 2 3 4];
...
% plot(angle_total,cpct_data,'ko','MarkerFaceColor','k')
xlabel('Angle')
ylabel('CPC')
title("Angle CPC' Comparison")
...
% plot(angle_min_norm_to_max_total,cpct_data,'ko','MarkerFaceColor','k')
xlabel('Angle')
ylabel('CPC')
title("Angle CPC' Comparison Norm")
...
% plot(angle_shift_then_norm_total,cpct_data,'ko','MarkerFaceColor','k')
xlabel('Angle')
ylabel('CPC')
title("Angle CPC' Comparison Shift Then Norm")
end